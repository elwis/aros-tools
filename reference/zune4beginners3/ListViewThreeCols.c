...
void RemoveItemFromList(int pos)
{
  ...
  free(selected_item_pointer->column3);
...
static ULONG myfunc_btn_inputbox_ok(struct Hook *hook, Object *object, APTR msg)
{
  ...
  {
    AddNewItemToList(XGET(inputfield,MUIA_String_Contents),
    		     XGET(inputfield2,MUIA_String_Contents),
    		     XGET(inputfield3,MUIA_String_Contents));
  }
  else // if change selected item button was clicked
  {
    ...
    strcpy(selected_item_pointer->column3, XGET(inputfield3, MUIA_String_Contents));
  ...
  set(inputfield3, MUIA_String_Contents, ""); // clear text in inputfield 3
...
int main(int argc,char *argv[])
{
    ...
    app = ApplicationObject,
        MUIA_Application_Title      , "ListViewObject with 3 columns app",
	...
	SubWindow,
	  window_inputbox = WindowObject,
            MUIA_Window_Title, "Enter three strings",
	      ...
	      Child,
              ...
              Child,
                  TextObject,
                  MUIA_Text_Contents, "Phone:",
              End,
              Child,
                  inputfield3 = StringObject,
                  StringFrame,
                  MUIA_String_Contents, "",
              End,
              Child,
        ...
        SubWindow,
            window = WindowObject,
            MUIA_Window_Title, "ListViewObject with 3 columns",
    ...
    AddNewItemToList("John Soter", "New York", "434112");
    AddNewItemToList("Ben Affleck", "San Francisco", "885223");
