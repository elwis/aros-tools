...
{
  set(inputbox, MUIA_TextEditor_Contents , "Button was clicked...");
  return 11;
}
...
static ULONG myfunc2(struct Hook *hook, Object *object, APTR msg)
{
  ...
  char *text = (char*) DoMethod(inputbox, MUIM_TextEditor_ExportText);
  
  // show message box
  MUI_Request(app, window, 0, "Message box", "OK", text);
  return 11;
}
...
int main(int argc,char *argv[])
{
    app = ApplicationObject,
        MUIA_Application_Title      , "TextEditor demo app",
