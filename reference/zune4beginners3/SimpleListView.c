...
int main(int argc,char *argv[])
{
    ...
    app = ApplicationObject,
        MUIA_Application_Title      , "Simple ListView app",
	...
	SubWindow,
	  window_inputbox = WindowObject,
            MUIA_Window_Title, "Enter some string",
        ...
        SubWindow,
            window = WindowObject,
            MUIA_Window_Title, "Simple ListViewObject",
    ...
    AddNewItemToList("First item");
    AddNewItemToList("Second item");
